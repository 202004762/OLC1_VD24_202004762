...
public class Raiz extends Instruccion {
    ...
    public Raiz(Instruccion opIzq, Instruccion opDer, int linea, int col) {
        ...
        switch(tipoIzq){
            case ENTERO -> {
                switch(tipoDer){
                    case ENTERO -> {
                        ...
                        return Math.pow((int) valorIzq, 1.0 / (int) valorDer);
                    ...
                    case DECIMAL -> {
                        this.tipo.setTipo(tipoDato.DECIMAL);
                        return Math.pow((int) valorIzq, 1.0 / (double) valorDer);
                        
                    }
                    
                    default -> {
                        return new Errores("error semantico", "raiz invalida", this.linea, this.col);
            ...
            case DECIMAL -> {
                switch(tipoDer){
                    case ENTERO -> {
                        this.tipo.setTipo(tipoDato.DECIMAL);
                        return Math.pow((double) valorIzq, 1.0 / (int) valorDer);
                        
                    }
                    
                    case DECIMAL -> {
                        this.tipo.setTipo(tipoDato.DECIMAL);
                        return Math.pow((double) valorIzq, 1.0 / (double) valorDer);
