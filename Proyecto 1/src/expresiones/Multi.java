...
public class Multi extends Instruccion {
    private Instruccion opIzq;
    private Instruccion opDer;

    public Multi(Instruccion opIzq, Instruccion opDer, int linea, int col) {
        ...
        switch(tipoIzq){
            case ENTERO -> {
                switch(tipoDer){
                    ...
                    default -> {
                        return new Errores("error semantico", "multiplicacion invalida", this.linea, this.col);
